#!/usr/bin/env python3
"""
Fetch whisper-stt deployment logs for the last 30 days.

This script retrieves logs from whisper-stt pods, plus deployment history
and events, then outputs them in JSONL format.
"""
...
def main():
    ...
    print("=== Fetching whisper-stt deployment logs ===\n")
    ...
    # Write to JSONL file
    output_file = "/home/coding/aide-de-camp/data/whisper-stt-logs.jsonl"
