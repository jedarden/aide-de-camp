"""Confirmation dialog templates and formatting utilities.

This module provides the template-based confirmation system from adc-46ksu.
Uses config/confirmations.yaml for templates.
"""
...
CONFIRMATIONS_CONFIG_PATH = Path(__file__).parent.parent.parent / "config" / "confirmations.yaml"
