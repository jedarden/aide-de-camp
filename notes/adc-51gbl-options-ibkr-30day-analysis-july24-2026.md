...
|--------|--------------|-------------------|--------------|------------------|-------|
| **Options Pipeline** | 🔴 CRITICAL | 218+ confirmed errors | ZeroDivisionError & calculation failures | HIGH - Active pod instability | 📈 Continuing failures |
...
**Frequency Analysis:**
- **30-Day Count:** 218+ confirmed error events across multiple pods
- **Primary Pod (24p6f):** 117 ZeroDivisionError occurrences
- **Secondary Pod (jlzqd):** 101 ZeroDivisionError occurrences  
...
```
2026-07-24 13:00:47 - ERROR Unexpected error
2026-07-24 13:24:31 - ERROR Unexpected error
2026-07-24 13:25:16 - ERROR Unexpected error
2026-07-24 13:26:01 - ERROR Unexpected error
2026-07-24 13:26:47 - ERROR Unexpected error
2026-07-24 13:27:32 - ERROR Unexpected error
2026-07-24 13:28:17 - ERROR Unexpected error
2026-07-24 13:29:02 - ERROR Unexpected error
2026-07-24 13:29:47 - ERROR Unexpected error
2026-07-24 13:30:33 - ERROR Unexpected error
2026-07-24 13:31:17 - ERROR Unexpected error
2026-07-24 13:32:03 - ERROR Unexpected error (last recorded)
```
...
- `options-greeks-7cbcd5dff4-24p6f`: 150 restarts (32 minutes ago - very recent)
- `options-greeks-7cbcd5dff4-jlzqd`: 98 restarts (4h40m ago)  
- `queue-reconciler-8d8b947ff-z8zqz`: 156 restarts (130m ago)
...
```
2026-07-24 13:27:20,409|I| Maintenance
2026-07-24 13:27:20,488|I| Gateway running and authenticated, session id: d39e31d26c71a55a54dc1a3638b04bd9, server name: JisfN8056
2026-07-24 13:28:20,409|I| Maintenance
2026-07-24 13:28:20,509|I| Gateway running and authenticated, session id: d39e31d26c71a55a54dc1a3638b04bd9, server name: JisfN8056
```
...
|--------|-----------------|----------|-------------------|
| **Total Errors (30d)** | 218+ | 0 | Infinite difference |
| **Error Rate** | 7.3+ per day | 0 per day | Complete contrast |
...
| **Log Lines Analyzed** | Error-focused sampling | 2,253 normal operations | Clean vs error-filled |
...
**Frequency:** Daily recurring (218+ events in 30-day sample)  
...
Pod Stability: 150+ restarts (very recent activity - 32 minutes ago)
...
- Error frequency: Consistent daily occurrences (7.3+ per day)
...
- **Active Status:** ZeroDivisionError confirmed occurring regularly (218+ in 30 days)
...
7. **Error Frequency:** Options Pipeline averaging 7.3+ errors per day vs IBKR MCP zero errors

### Comparative Reliability Assessment

| Reliability Dimension | Options Pipeline | IBKR MCP | Superior System |
|----------------------|-----------------|----------|-----------------|
| **Error Rate** | 7.3+ per day | 0 per day | 🏆 IBKR MCP |
...
**Key Metrics:**
- Options Pipeline: 218+ error events, 404 pod restarts
