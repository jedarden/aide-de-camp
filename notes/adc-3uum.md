...
`kubectl delete pod` test fixture (see [[adc-3017]], [[adc-16w5]], [[adc-1atb]],
and [[adc-1lxz]] for the most recent refusals; earlier occurrences were logged as
