...
environment's safety posture forbids. This is the **sixth** identical occurrence of this
...
intent matches `kubectl delete pod` but the source utterance carries no operand. Six
...
specify a target — same outcome as the five prior identical beads.
