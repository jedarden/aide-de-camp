...
|--------|--------------|-------------------|--------------|------------------|-------|
| **Options Pipeline** | 🔴 CRITICAL | 228+ confirmed errors | ZeroDivisionError & calculation failures | HIGH - Active pod instability | 📈 Continuing failures |
...
**Frequency Analysis:**
- **30-Day Count:** 228+ confirmed error events in primary pod alone
...
```
2026-07-24 13:00:47 - ERROR Unexpected error - ZeroDivisionError
2026-07-24 13:01:32 - ERROR Unexpected error - ZeroDivisionError
2026-07-24 13:02:17 - ERROR Unexpected error - ZeroDivisionError
2026-07-24 13:03:02 - ERROR Unexpected error - ZeroDivisionError
2026-07-24 13:03:47 - ERROR Unexpected error - ZeroDivisionError
[Pattern continues at ~45 second intervals]
```
...
- `options-greeks-7cbcd5dff4-24p6f`: 150 restarts (71m ago - very recent)
- `options-greeks-7cbcd5dff4-jlzqd`: 98 restarts (5h19m ago)  
- `queue-reconciler-8d8b947ff-z8zqz`: 156 restarts (169m ago)
...
```
2026-07-24 14:06:20,409|I| Maintenance
2026-07-24 14:06:20,414|D| POST https://localhost:5000/v1/api/tickle (unverified)
2026-07-24 14:06:20,460|I| Gateway running and authenticated, session id: d39e31d26c71a55a54dc1a3638b04bd9, server name: JisfN8056
2026-07-24 14:06:20,460|D| GET https://localhost:5000/v1/portal/sso/validate (unverified)
2026-07-24 14:07:20,409|I| Maintenance
2026-07-24 14:07:20,415|D| POST https://localhost:5000/v1/api/tickle (unverified)
2026-07-24 14:07:20,472|I| Gateway running and authenticated, session id: d39e31d26c71a55a54dc1a3638b04bd9, server name: JisfN8056
```
...
|--------|-----------------|----------|-------------------|
| **Total Errors (30d)** | 228+ | 0 | Infinite difference |
| **Error Rate** | 7.6+ per day | 0 per day | Complete contrast |
...
**Frequency:** Daily recurring (228+ events in 30-day sample)  
...
Pod Stability: 150+ restarts (very recent activity - 71 minutes ago)
...
- Error frequency: Consistent daily occurrences (7.6+ per day)
...
- **Active Status:** ZeroDivisionError confirmed occurring regularly (228+ in 30 days)
...
7. **Error Frequency:** Options Pipeline averaging 7.6+ errors per day vs IBKR MCP zero errors

### Comparative Reliability Assessment

| Reliability Dimension | Options Pipeline | IBKR MCP | Superior System |
|----------------------|-----------------|----------|-----------------|
| **Error Rate** | 7.6+ per day | 0 per day | 🏆 IBKR MCP |
...
**Key Metrics:**
- Options Pipeline: 228+ error events, 404 pod restarts
